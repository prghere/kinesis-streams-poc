...
package com.erdos.aws.stocktrades.processor;

import java.util.EnumMap;
import java.util.HashMap;
import java.util.Map;

import com.erdos.aws.stocktrades.model.StockTrade;
import com.erdos.aws.stocktrades.model.StockTrade.TradeType;
